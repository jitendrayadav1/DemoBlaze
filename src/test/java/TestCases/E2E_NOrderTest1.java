...
public class E2E_NOrderTest1 extends BaseTest {
	...
	String expProduct="Samsung galaxy s611111";
...
//		js.executeScript("window.scrollBy(0,200)");
	//click onmonitor 
		...
		Assert.assertEquals(expProduct,actualCartProduct,"Assertion on product is failed ");
