...
public class ExtentListeners implements ITestListener, ISuiteListener{
	...
	public void onTestSuccess(ITestResult result) {
		...
		String logText = "<b>" + "TEST CASE:- " + methodName.toUpperCase() + " PASSED ON <h4><font color=white> "+capabilities.getBrowserName().toUpperCase() + "</b>";
	...
	public void onTestFailure(ITestResult result) {
		...
		String methodName=result.getMethod().getMethodName();
		String logText="<b>"+"TEST CASE:- "+ methodName.toUpperCase()+ " FAILED on  <h4><font color=white>"+capabilities.getBrowserName().toUpperCase() +"</b>";	
